            ...
            <div class="media text-muted pt-3">
              ...
              <div class="media-body pb-3 mb-0 small border-bottom border-gray">
                <div class="d-flex justify-content-between align-items-center w-100">
                  <?= $this->Html->link($post->name, ['controller' => 'Posts', 'action' => 'edit', $post->id], ['class' => 'post_id']) ?>
                  <i class="<?= ($post->status == 1) ? 'fas fa-check-circle text-success' : 'fas fa-lock text-muted' ?>"></i>
                </div>
